...
\begin{enumerate}
	...
	\item 
		\begin{itemize}
			\item \chemform{3CuSo_4 \cdot 5H_2O} : sulfate de cuivre pentahydrat\'e ;
			\item \chemform{2PH_3} : phosphine ;
			\item \chemform{Cu_3P_2} : phosphure de cuivre (II) ;
			\item \chemform{3H_2SO_4} : acide sulfurique ;
			\item \chemform{15H_2O} : monoxyde de dihydrog\`ene.
		\end{itemize}
	\item
