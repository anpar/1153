...
\begin{enumerate}\renewcommand{\theenumi}{\alph{enumi}}
	...
	\item	La structure de Lewis du \chemform{CH_3OH} est :
				...
				La molécule est \textbf{polaire}(pas de symétrie)
	\item La structure de Lewis du \chemform{CH_3COCH_3} est :	
				
				\chemfigc{H-C(-[:90]H)(-[:-90]H)-C(=[:90]O)-C(-[:90]H)(-[:-90]H)-H}
				
				La molécule est \textbf{polaire}(pas de symétrie totale)
\end{enumerate}
...
\begin{enumerate}\renewcommand{\theenumi}{\alph{enumi}}
	...
	\item Les liaisons \chemform{HCH} forment un angle légèrement $<$ 120 degrés (118°)
				Les liaisons \chemform{HCC} forment un angle légèrement $>$ 120 degrés (122°)
