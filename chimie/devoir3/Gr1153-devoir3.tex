...
\begin{enumerate}\renewcommand{\theenumi}{\alph{enumi}}
	\item La structure de Lewis du \chemform{CI_4} est :
				...
				La molécule est \textbf{apolaire} (symétrie, donc somme des moments dipolaires nulle).
	\item	La structure de Lewis du \chemform{CH_3OH} est :
		
				\chemfigc{H-C(-[:90]H)(-[:-90]H)-\lewis{26, O}-H}
				
				La molécule est \textbf{polaire}. (sommes des moments dipolaires non-nulle)
...
\begin{enumerate}\renewcommand{\theenumi}{\alph{enumi}}
	...
	\item	Tous les atomes d'hydrogène seront dans le même plan, excepté pour \chemform{H_2CCCH_2}: Les liaisons $\pi$ recouvrent latéralement les orbitales $2p$ perpendiculaires sur l'atome de C central.
	\item	Si x est pair, les atomes d'hydrogène sont coplanaires. 
	Par contre, si x est impair, l'orientation relative des atomes H en bout de chaîne sera différente: les plans formés par les \chemform{CH_2} seront perpendiculaires.
