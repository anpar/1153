...
\begin{enumerate}\renewcommand{\theenumi}{\alph{enumi}}
	...
	\item Plus il y a d'interactions intermoléculaires et plus
				...
				et de fusion augmente. On a donc : \chemform{CH_3COOH}
				$>$ \chemform{CH_3CL} $>$ \chemform{CH_4}. En effet : 
...
\begin{enumerate}\renewcommand{\theenumi}{\alph{enumi}}
	\item	\chemform{FeS_2} : métallique.
	\item	\chemform{C_8H_{19}} : covalent.
	\item	\chemform{BN} : covalent.
	\item	\chemform{CaSO_4} : ionique.
	\item	\chemform{Cr_2} : moléculaire.
	% Peut-être justifier un peu? Et est-ce qu'on est sur que
	% c'est bien Cr2 pour le dernier?
\end{enumerate}	
