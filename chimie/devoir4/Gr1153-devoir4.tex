...
\begin{enumerate}\renewcommand{\theenumi}{\alph{enumi}}
	\item	\chemform{FeS_2} : covalent car faible $\Delta \chi$ : 0.75
	...
	\item	\chemform{Cr_2} : métallique car ce sont des cations maintenus ensemble par une mer d'électrons.
\end{enumerate}	
