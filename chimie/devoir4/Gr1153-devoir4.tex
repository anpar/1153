...
\begin{enumerate}\renewcommand{\theenumi}{\alph{enumi}}
	\item	\chemform{FeS_2} : les solides comportant un atome 
				de fer son métalliques par définition.
	\item	\chemform{C_8H_{19}} : covalent car faible $\Delta \chi$.
	\item	\chemform{BN} : covalent car faible $\Delta \chi$.
