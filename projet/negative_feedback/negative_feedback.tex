...
\begin{figure}[h]
	\centering
	% Circuit à redessiner, j'ai pas fais ça très proprement.
	\begin{circuitikz}
		\draw (0, 0) node[ocirc];
...
<<<<<<< HEAD:projet/prejury/documentation/negative_feedback/negative_feedback.tex
...
=======
La possibilité la plus simple est la deuxième, car en choississant $R_2 = 0$, le gain est donné par $\frac{R_1}{R_1}$. Autrement dit : quelque soit $R_1$, $A = 1$. On choisi alors $R_1$ si petit, que le remplacer par un court-circuit a le même effet.
>>>>>>> 5e801e9a81cbe8962ef2873a74e38067572f3bc2:projet/negative_feedback/negative_feedback.tex
