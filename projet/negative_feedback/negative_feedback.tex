...
Sur la Figure \ref{reaction2}, on remarque que la tension de sortie et la tension d'entrée sont liées 
...
que le remplacer par un simple court-circuit aurait le même effet.
