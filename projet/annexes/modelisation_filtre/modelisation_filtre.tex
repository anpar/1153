...
Sur le circuit ci-dessus, on peut utiliser la loi des tensions de Kirchoff :
...
Cette équation va être la base des deux méthodes qui suivent. On va également utiliser 
