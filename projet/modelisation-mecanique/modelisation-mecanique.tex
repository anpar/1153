...
Où $A$ et $B$ sont des coéfficients complexes. On peut réecrire cette solution
...
Où $C$ et $D$ sont cette fois des coéfficients réels.
...
En utilisant la première condition initiale, $\fv{x}(0) = 0$, on trouve :
