...
Avant de pouvoir déterminer le nombre de spires de la bobine mouvante, nous avons dû déterminer expérimentalement la constante de raideur de notre papier pour faire la membrane.
Notre procédure a été la suivante: nous avons suspendu notre membrane, pour ensuite déposer un poids dessus, et finalemet mesurer l'élongation du matériau.
...
En fixant le rayon à \unit{30}{mm}, nous pouvons déterminer $N_2$ ainsi que la longueur de la bobine:
$$L_{fil} = N_2 \cdot 2\pi r$$ 
$$N_2 =  \frac{L_{fil}}{2\pi r} = 69$$
...
$$L = N_1 \frac{\phi_B}{I} = \unit{0.0134}{\henry}$$
...
\begin{center}
	\begin{tabular}{c|c|c|c}
		$N_2$ & $I$ & $R$ & $L$ \\
		\hline
		 $69$ & $\unit{0.1667}{\ampere}$ & $\unit{2.38}{\ohm}$ & $\unit{0.0134}{\henry}$ \\
	\end{tabular}
\end{center}
