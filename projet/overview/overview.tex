...
empilées les unes sur les autres. La géométrie de l'électroaimant permet de concentrer le
champ magnétique dans l'entrefer tandis que l'utilisation de fines lamelles empilées permet
d'éviter les pertes dûes au courant de \textsc{Foucault}. La perméabilité magnétique élevée 
de ce matériau ($\mu_r \approx \ 1600$) permet de créer un champ magnétique plus fort. 
Autour de la branche centrale du ''E'' est enroulé du fil de cuivre, formant ainsi une bobine.
