...
On remarque donc que le déphasage entre $V_{out}$ et $V_{in}$ est $\arctan(-RC\omega)$.
...
On peut ensuite comparer les graphes de $V_{out}$, $V_{in}$. %et $V_{out} / V_{in}$
...
\begin{tikzpicture}[>=stealth]
    \begin{axis}[
        ...
        \addplot[no marks,black,-] expression[domain=0:6,samples=1000]
						%{(7.5)/(1 + 20^2 * 1000^2 * (0.00001)^2) * (cos(20*x) + 1000*20*(0.00001)*sin(20*x) - 2.718^(-x/(1000*0.00001)))} 
...
\begin{tikzpicture}[>=stealth]
    \begin{axis}[
        ...
        ylabel={$f$},
				...
				\addplot[no marks,green,-] expression[domain=0:100,samples=1000]
						{(((7.5)/(sqrt(1 + 1000^2 * 0.00001^2 * (2*3.14*x)^2))) * (((-2.718^((-1)/(1000*0.00001)))/(sqrt(1 + 1000^2 * 0.00001^2 * (2*3.14							*x)^2))) + cos(atan(-1000*0.00001*2*3.14*x) + 2*3.14*x)))/(7.5 * cos(2*3.14*x))}
						node[pos=0.65,anchor=south west]{$V_{out} / V_{in}$}; 
    \end{axis}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[>=stealth]
    \begin{axis}[
        ...
        ylabel={$f$},
				...
				% D'abord trouver une explication	
				\addplot[no marks,green,-] expression[domain=0:100,samples=1000]
						{((7.5 * cos(2*3.14*x)) - ((7.5)/(sqrt(1 + 1000^2 * 0.00001^2 * (2*3.14*x)^2))) * (((-2.718^((-1)/(1000*0.00001)))/(sqrt(1 + 1000							^2 *0.00001^2 * (2*3.14*x)^2))) + cos(atan(-1000*0.00001*100) + 2*3.14*x)))/(7.5 * cos(2*3.14*x))}
						node[pos=0.65,anchor=south west]{$V_{out} / V_{in}$}; 
    \end{axis}
\end{tikzpicture}
\end{center}
