...
\begin{tikzpicture}[>=stealth]
    \begin{axis}[
        ...
        \addplot[no marks,black,-] expression[domain=0:25,samples=1000]
				...
				%\addplot[no marks,green,-] expression[domain=0:25,samples=1000]
				%		{(((7.5)/(sqrt(1 + 1000^2 * 0.00001^2 * 400^2))) * (((-2.718^((-x)/(1000*0.00001)))/(sqrt(1 + 1000^2 * 0.00001^2 * 400^2))) 
				%		+ cos(	atan(-1000*0.00001*400) + 400*x)))/(7.5 * cos(400 * x))}
...
Pour le graphe, les valeurs suivantes ont été utilisées : $V_{max} = \unit{7.5}{\volt}$, $C = \unit{0.00001}{\farad}$,
$R = \unit{1000}{\ohm}$ et $\omega = \unit{15.91}{\hertz}$.
...
\begin{tikzpicture}[>=stealth]
    \begin{axis}[
        ...
        \addplot[no marks,black,-] expression[domain=0:25,samples=1000]
				...
				%\addplot[no marks,green,-] expression[domain=0:25,samples=1000]
				%		{((7.5 * cos(100*x)) - ((7.5)/(sqrt(1 + 1000^2 * 0.00001^2 * 100^2))) * (((-2.718^((-x)/(1000*0.00001)))/(sqrt(1 + 1000^2 *
				%		0.00001^2 * 100^2))) + cos(atan(-1000*0.00001*100) + 100*x)))/(7.5 * cos(100 * x))}
				%		node[pos=0.65,anchor=south west]{$V_{out} / V_{in}$}; 
    \end{axis}
\end{tikzpicture}
\end{center}
