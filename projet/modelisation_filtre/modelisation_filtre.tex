...
$$V_{out,3} = \frac{V_{out,1} \cdot V_{out,2}}{V_{in1}}$$
...
\begin{tikzpicture}[>=stealth]
    \begin{axis}[
        ...
        xlabel={$f$},
        ylabel={$V_{out} / V_{in}$},
				legend entries = {passe-bande, fréq. coupure1, fréq. coupure 2}
        ]
...
\end{axis}
\end{tikzpicture}
\caption{Graphe de $V_{out} / V_{in}$ pour le filtre passe-bande}
\label{lwp_ratio}
\end{figure}
\subsubsection{Vérification des résultats}
